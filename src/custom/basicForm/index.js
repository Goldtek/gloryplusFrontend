...
await firestore.collection("basic").add(values);
swal('Registration successful. you will be redirected to join the Gloryplus Basic Academy group on whatsapp.', "Info").then((value) => {
 window.location='https://chat.whatsapp.com/CRG2zTBTgoEHotjiVS4pOr';
});
setTimeout(() => {
