...
await firestore.collection("membership").add(values);
swal('Registration successful. you will be redirected to join the membership group on whatsapp.', "Info").then((value) => {
 window.location='https://chat.whatsapp.com/JoFR7OQ7GHa5ZaRRUlZwxI';
});
setTimeout(() => {
